...
CREATE TABLE "OrderItem" (
    ...
    "finish" TEXT,
    "customWording" TEXT,
    "unitPriceEstimate" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "lineTotalEstimate" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE "OrderApproval" ADD CONSTRAINT "OrderApproval_respondedById_fkey" FOREIGN KEY ("respondedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
